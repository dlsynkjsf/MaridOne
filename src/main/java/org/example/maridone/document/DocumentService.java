...
public class DocumentService {
    ...
    @ExecutionTime
    public DocumentPath upload(MultipartFile file, String username) {
        ...
        return documentPathRepository.save(doc);
    }

    @ExecutionTime
    public DocumentPath replace(Long pathId, MultipartFile file, String username) {
        DocumentPath document = documentPathRepository.findById(pathId)
                .orElseThrow(() -> new RuntimeException("Document not found"));
        ...
        return documentPathRepository.save(document);
    }
